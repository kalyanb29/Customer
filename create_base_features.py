...
offers_file = os.getcwd() + "/offers.csv"
transactions_file = os.getcwd() + "/transactions.csv"
if testset:
	history_file = os.getcwd() + "/testHistory.csv"
else:
	history_file = os.getcwd() + "/trainHistory.csv"

# will be created
reduced_file = os.getcwd() + "/reduced.csv"
if testset:
	folder = os.getcwd() + "/test/"
else:
	folder = os.getcwd() + "/train/"
